...
aws s3 rb s3://osts-airflow-dev-codepipeline-artifacts --force
aws s3 rb s3://osts-airflow-staging-codepipeline-artifacts --force
...
aws cloudformation delete-stack --stack-name=airflow-staging-pipelincleare
